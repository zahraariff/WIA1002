...
//    public V getSpecificStop(int index){
//        return listOfStops.get(index);
//    }
    ...
    public boolean addVertex(V v){
        if(hasVertex(v)==false){
            ...
            if(head==null){
                head=tail=newVertex;
                //listOfStops.add(newVertex.vertexInfo);
            }else{
    ...
    public void addStop(V source, V destination, E cost){
        ...
        addUndirectedEdge(source,destination,cost);
    }
